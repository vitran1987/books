...
class BlockchainICOEPUBGenerator:
    def __init__(self):
        ...
        # Chapter and section structure for Blockchain ICO book - Series 2
        self.chapters = [
            {
                "num": 1, 
                "title": "Tại Sao Cần Điều Chỉnh Governance Model", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-01-governance-model-adjustment.md", "title": "Tại Sao Cần Điều Chỉnh Governance Model"}
                ]
            },
            {
                "num": 2, 
                "title": "Tại Sao Chỉ Cần Một Token Duy Nhất (BG Only)", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-02-single-token-design.md", "title": "Tại Sao Chỉ Cần Một Token Duy Nhất (BG Only)"}
                ]
            },
            {
                "num": 3, 
                "title": "Cơ Chế Cung Token Linh Hoạt", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-03-flexible-supply.md", "title": "Cơ Chế Cung Token Linh Hoạt"}
                ]
            },
            {
                "num": 4, 
                "title": "Cơ Chế Halving Dựa Trên Thị Trường", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-04-market-driven-halving.md", "title": "Cơ Chế Halving Dựa Trên Thị Trường"}
                ]
            },
            {
                "num": 5, 
                "title": "Dự Án Tài Chính Thực Tế - Realistic Financial Projections", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-05-realistic-projections.md", "title": "Dự Án Tài Chính Thực Tế - Realistic Financial Projections"}
                ]
            },
            {
                "num": 6, 
                "title": "Nền Tảng Không Nắm Giữ Token - Platform Zero Token Holdings", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-06-platform-zero-tokens.md", "title": "Nền Tảng Không Nắm Giữ Token - Platform Zero Token Holdings"}
                ]
            },
            {
                "num": 7, 
                "title": "Cơ Chế Đốt Token Linh Hoạt (Dynamic Burn Mechanisms)", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-07-dynamic-burn.md", "title": "Cơ Chế Đốt Token Linh Hoạt (Dynamic Burn Mechanisms)"}
                ]
            },
            {
                "num": 8, 
                "title": "Cơ Chế Chống Whale và Chống Đầu Cơ (Anti-Whale & Anti-Speculation Mechanisms)", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-08-anti-whale-mechanisms.md", "title": "Cơ Chế Chống Whale và Chống Đầu Cơ (Anti-Whale & Anti-Speculation Mechanisms)"}
                ]
            },
            {
                "num": 9, 
                "title": "Thuế và Kế Toán Việt Nam (Tax & Accounting in Vietnam)", 
                "dir": ".",
                "sections": [
                    {"file": "chuong-09-thue-ke-toan-vietnam.md", "title": "Thuế và Kế Toán Việt Nam (Tax & Accounting in Vietnam)"}
                ]
            }
        ]
...
<body class="title-page">
    ...
    <div class="publication-info">
        ...
        <p><strong>Phạm vi:</strong> Điều chỉnh governance, thiết kế token đơn giản, cơ chế cung linh hoạt, halving thị trường, dự án tài chính thực tế, platform zero tokens, dynamic burn, anti-whale và thuế kế toán Việt Nam</p>
        <p><strong>Nội dung:</strong> Governance Adjustment, Single Token BG, Flexible Supply, Market-Driven Halving, Realistic Projections, Platform Zero Holdings, Dynamic Burn, Anti-Whale Mechanisms, Vietnam Tax &amp; Accounting</p>
    </div>
</body>
</html>'''
...
{chr(10).join(nav_links)}
    ...
    def create_content_opf(self):
        ...
        # Metadata
        title = "BG Internal Book Series 2 - Cải Tiến Governance và Cơ Chế Token"
        description = "Tài liệu nội bộ toàn diện về cải tiến governance model và các cơ chế token tiên tiến của BG. Bao gồm 9 chương: Tại Sao Cần Điều Chỉnh Governance Model, Tại Sao Chỉ Cần Một Token Duy Nhất (BG Only), Cơ Chế Cung Token Linh Hoạt, Cơ Chế Halving Dựa Trên Thị Trường, Dự Án Tài Chính Thực Tế, Nền Tảng Không Nắm Giữ Token, Cơ Chế Đốt Token Linh Hoạt, Cơ Chế Chống Whale và Chống Đầu Cơ, và Thuế và Kế Toán Việt Nam. Tập trung vào các cải tiến governance để tối ưu hóa ra quyết định, thiết kế token đơn giản hóa, cơ chế cung linh hoạt theo nhu cầu thị trường, halving thông minh, dự án tài chính khả thi, platform không nắm giữ token, dynamic burn mechanisms, anti-whale protection và tuân thủ thuế kế toán Việt Nam."
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="bookid" version="3.0">
    <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
        ...
        <dc:subject>Market-Driven Halving</dc:subject>
        <dc:subject>Realistic Financial Projections</dc:subject>
        <dc:subject>Platform Zero Token Holdings</dc:subject>
        <dc:subject>Dynamic Burn Mechanisms</dc:subject>
        <dc:subject>Anti-Whale Mechanisms</dc:subject>
...
{chr(10).join("        " + item for item in spine_items)}
    ...
    def generate(self):
        ...
        print("🚀 Starting BG Internal Book Series 2 EPUB generation...")
        print("📊 Target: 9 chapters covering governance improvements and advanced token mechanisms")
        print("📚 Topics: Governance Adjustment, Single Token Design, Flexible Supply, Market Halving, Realistic Projections, Platform Zero Tokens, Dynamic Burn, Anti-Whale, Vietnam Tax")
        print("=" * 70)
        ...
        try:
            ...
            print("="  * 70)
            print("🎉 BG Internal Book Series 2 EPUB generation completed!")
            print(f"📚 Output file: {self.epub_file}")
            print("📊 Structure: 9 chapters covering governance improvements and advanced token mechanisms")
            print("🔗 Content: Governance Adjustment, Single Token, Flexible Supply, Market Halving, Realistic Projections, Platform Zero, Dynamic Burn, Anti-Whale, Vietnam Tax")
