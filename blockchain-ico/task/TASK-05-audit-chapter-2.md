...
**Dependencies:** TASK-01 methodology

---

## 📋 OBJECTIVES

1. **Complete audit of all 8 Chapter 2 files** (~30,000 words total)
2. **Identify duplicate case studies** (Bitcoin Pizza Day, Binance Coin, etc.)
3. **Map content to token economics concepts** (types, supply, distribution, incentives)
4. **Assign primary homes** for each case study (one detailed version only)
5. **Create reorganization plan** for TASK-06 through TASK-10
...
- `chapter-02\04-phan-phoi-token.md`
- `chapter-02\05-co-che-khuyen-khich.md`
- `chapter-02\06-gia-tri-token.md`
- `chapter-02\07-nghien-cuu-truong-hop.md`
- `chapter-02\08-tuong-lai-token-economics.md`
...
- Duplicate stories (compare with overview + Chapter 1)
...
- YFI: File 04 (distribution - fair launch)
...
- [ ] Complete inventory in Excel (8 files analyzed)
- [ ] Duplicate analysis identifies all repeated stories
- [ ] Primary home assigned for each case study
- [ ] Reorganization plan ready for execution
- [ ] Estimated 40-50% content reduction identified
...
These appear in overview AND Chapter 2 - keep detailed version in Ch2, make overview brief.

---

**NEXT TASK:** TASK-06 (Reorganize token types)
